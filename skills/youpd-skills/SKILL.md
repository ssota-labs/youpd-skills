...
| 사용자 의도 | 읽을 파일 | 구현 상태 |
|---|---|---|
| 설치 + 채널 첫 온보딩 (터미널 없음, 유저는 채팅만) | `references/setup/onboarding.md` | 사용 가능 |
| 스킬 툴킷 설치 (`npx skills add`, 에이전트가 Shell) | `references/setup/install-skills.md` | 사용 가능 |
...
- `references/setup/onboarding.md` — 설치·채널·API·시청자 (유저 한 줄: 「설치하고 온보딩해줘」)
- `references/setup/install-skills.md` — `npx skills add` (에이전트 Shell)
